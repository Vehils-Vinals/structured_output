...
def build_field_comparison_table(expected: Dict[str, Any], actual: Dict[str, Any] | None) -> pd.DataFrame:
        ...
        rows.append(
            {
                ...
                "probleme_attendu": result["expected_problem"],
                "matched_fields": result["matched_fields"],
                "total_fields": result["total_fields"],
                "match_rate": result["match_rate"],
                "principaux_ecarts": result["main_differences"],
            }
        )
